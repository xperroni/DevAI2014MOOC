...
class Agent(object):
    ...
    def run(self, turns = 10, patience = 3):
        r'''Runs the agent for the specified number of turns.
            ...
            with negative valence, or after it gets bored for being pleased for as many turns
            as the value of the patience argument.
        '''
        satisfaction = 0
        for i in range(0, turns):
            ...
            satisfaction = satisfaction + 1 if mood == Pleased else 0

            if satisfaction >= patience:
                satisfaction = 0
                mood = Bored
